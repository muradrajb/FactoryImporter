...
module.exports =class Treatment_2 extends TreatmentSuper {

    constructor(file_path) { // hospital-specific header  
        //  TreatmentId,PatientId,ProtocolID,StartDate,EndDate,Status,DisplayName,AssociatedDiagnoses,NumberOfCycles
        // const [treatment_id,patient_id,status,start_date,end_date,display_name,protocol_id,diagnoses,treatment_line,number_of_cycles,cycles_days,days_per_cycle]=header;
         super(['TreatmentId','PatientId','Status','StartDate','EndDate','DisplayName','ProtocolID','AssociatedDiagnoses',null,'NumberOfCycles',null,null],file_path);
    }
